  ...
  <div class="wrapper d-flex">
            ...
            <form method="POST" action="#">
              <label>select category </label>
                    <select name="catname">
                        ...
                        include "config.php";
                        $id = $_GET['id'];
                        $sql = "select * from addblogs where blogid = '$id'";
                    ...
                    <option value="<?php echo $cate; ?> "><?php echo $cate; ?>
                    <?php }?>
    ...
    <br>
       ...
       <label class=" text-primary"> Enter Blog name :-
           </label><input type="text"  name="blog" value="<?php echo $bname; ?>">
           <br>
           <br>
           <label class=" text-primary"> Enter Description :-</label>
           <br>
           <textarea name="des" rows = "3" cols= "25"  > <?php echo $blogdes; ?></textarea>
           <br>
...
$des = $_POST['des'];
    ...
    $sql = "update addblogs set catname='$catname',blogname='$blog',blogdes='$des' where blogid = '$id' ";
    $query = mysqli_query($con,$sql);
    if($query)
    {
